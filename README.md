...
**Featured — slides from a real published paper.** Generated by the full
interview → outline-approval → generate workflow from Blankespoor, deHaan & Li,
*Generative AI in Financial Reporting* (**Journal of Accounting Research**,
2026): a 25-slide ~20-minute conference deck, faithful to the paper's own
numbers (the original Figure 1 is described, not fabricated).
...
[📄 Full deck](examples/blankespoor2026-generative-ai-in-financial-reporting.pdf)
